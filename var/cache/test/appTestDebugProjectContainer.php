...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.ranking.round' => 'getApp_Ranking_RoundService',
    ...
    /**
     * Gets the 'app.ranking.round' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Ranking\Round A AppBundle\Services\Ranking\Round instance.
     */
    protected function getApp_Ranking_RoundService()
    {
        return $this->services['app.ranking.round'] = new \AppBundle\Services\Ranking\Round($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'badminton_test', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3f50d4525baa98332684f2b58ab23a780fc68764196d06405d601ec28e713629');
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.filter.less.cssrewrite' => NULL,
