...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.match_scheduler' => 'getApp_MatchSchedulerService',
            'app.round_ranking' => 'getApp_RoundRankingService',
            'app.round_results' => 'getApp_RoundResultsService',
            'app.schedule_normalizer' => 'getApp_ScheduleNormalizerService',
            'app.schedule_serializer' => 'getApp_ScheduleSerializerService',
    ...
    /**
     * Gets the 'app.match_scheduler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\MatchScheduling\MatchScheduler A AppBundle\Services\MatchScheduling\MatchScheduler instance.
     */
    protected function getApp_MatchSchedulerService()
    {
        return $this->services['app.match_scheduler'] = new \AppBundle\Services\MatchScheduling\MatchScheduler($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.round_ranking' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\RoundRanking A AppBundle\Services\RoundRanking instance.
     */
    protected function getApp_RoundRankingService()
    {
        return $this->services['app.round_ranking'] = new \AppBundle\Services\RoundRanking($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.round_results' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\RoundResults A AppBundle\Services\RoundResults instance.
     */
    protected function getApp_RoundResultsService()
    {
        return $this->services['app.round_results'] = new \AppBundle\Services\RoundResults($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.schedule_normalizer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\MatchScheduling\ScheduleNormalizer A AppBundle\Services\MatchScheduling\ScheduleNormalizer instance.
     */
    protected function getApp_ScheduleNormalizerService()
    {
        return $this->services['app.schedule_normalizer'] = new \AppBundle\Services\MatchScheduling\ScheduleNormalizer($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.schedule_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\MatchScheduling\ScheduleSerializer A AppBundle\Services\MatchScheduling\ScheduleSerializer instance.
     */
    protected function getApp_ScheduleSerializerService()
    {
        return $this->services['app.schedule_serializer'] = new \AppBundle\Services\MatchScheduling\ScheduleSerializer();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'dbname' => 'badminton', 'host' => 'localhost', 'port' => NULL, 'user' => 'smash_db', 'password' => 'nolens0#Gesetze', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0facade1b250e30432cede23f1068eafac82857ea104ca4a8490958af20475ce');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.default' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/add_game');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/scheduling');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/api');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/crud');
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'home'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'default', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'default', $n, $o, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56e2f7a415e6d8.92196866', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'default', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, 'login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('installation_name', 'E pluribus smashum');
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        ...
        $b = $this->get('security.role_hierarchy', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        $c = new \Symfony\Component\Security\Core\Authorization\Voter\RoleVoter();

        $d = new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage();

        $e = new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter($d, $a, $b);

        $f = new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($a);
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'fb300480', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'smash_db',
            'database_password' => 'nolens0#Gesetze',
